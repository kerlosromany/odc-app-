...
class Plants extends StatelessWidget {
    ...
    return BlocConsumer<HomeCubit, HomeStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: HomeCubit.get(context).plantModel != null,
          fallback: (context) =>
              const Center(child: CircularProgressIndicator()),
          builder: (context) => buildPlants(
              HomeCubit.get(context).plantModel as PlantModel, context),
        );
      },
    );
  }

  Widget buildPlants(PlantModel model, context) {
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: List.generate(model.data.length,
                  (index) => buildGridPlant(model.data[index], context)),
              mainAxisSpacing: 5.0,
  ...
  Widget buildGridPlant(DataPlantModel model, context) {
    return Column(

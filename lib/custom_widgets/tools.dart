...
class Tools extends StatelessWidget {
    ...
    return BlocConsumer<HomeCubit, HomeStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: HomeCubit.get(context).toolsModel != null,
          fallback: (context) =>
              const Center(child: CircularProgressIndicator()),
          builder: (context) =>
              buildTools(HomeCubit.get(context).toolsModel as ToolsModel , context),
        );
      },
    );
  }

  Widget buildTools(ToolsModel model , context) {
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: List.generate(model.data.length,
                  (index) => buildGridTool(model.data[index] , context)),
              mainAxisSpacing: 5.0,
  ...
  Widget buildGridTool(DataToolModel model , context) {
    return Column(
